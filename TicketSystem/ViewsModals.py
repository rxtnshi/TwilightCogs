...
class SetupSendPanelButton(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        def make_embed():
            ...
            embed.add_field(name="🔨 Appeals Requests", value="You may create an appeal request for our Discord or game servers here. Appeals will only be accepted if a moderated action was incorrectly issued.", inline=False)
