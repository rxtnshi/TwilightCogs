...
class TicketSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if not cog:
            ...
            await interaction.followup.edit_message(views=TicketView())
            return
...
class DecisionSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.followup.edit_message(views=AppealView())
...
class CloseTicket(discord.ui.Button):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        await interaction.followup.edit_message(views=CloseTicketView())
